...
export const UI = {
  is: {
    ...
    faqItems: [
      ...
      { q: "Kostar þjónustan eitthvað?", a: "Fyrstu tveir kaflarnir eru ókeypis. Fullur aðgangur er keyptur með eingreiðslu, eitt verð, engin áskrift. Sjá <a href='/pricing.html' style='color:var(--gold);'>verðskrá</a>." },
      ...
      { q: "Get ég prentað barnasöguna mína sem alvöru bók?", a: "Já! Sæktu PDF og pantaðu prentað eintak í gegnum lulu.com — harðspjaldabók eða bók með mjúkri kápu, send heim til þín. (lulu.com er algjörlega ótengt Barnasögu minni.)" },
      { q: "Hvað með titil á bókina?", a: "Þegar sagan þín er tilbúin stingur kerfið upp á 5 skapandi titlum byggðum á frásögninni þinni. Þú getur valið þann besta eða skrifað þinn eigin." },
      { q: "Hvar birtast myndirnar mínar?", a: "Í PDF-bókinni fær hver kafli sína eigin myndasíðu (Gallery Plate) þar sem myndirnar þínar eru settar upp á smekklegan hátt strax á eftir textanum." },
      { q: "Hvað ef ég vil að sagan sé einföld og bein, án tilfinningasemi?", a: "Þú getur valið 'Hnitmiðaður' þegar þú býrð til bókina. Þá skrifar kerfið hnitmiðaða og staðreyndarlega barnasögu þar sem lykilatriðin úr svörunum þínum fá að tala sínu máli, án tilfinningasems eða dramatísks málfars." },
