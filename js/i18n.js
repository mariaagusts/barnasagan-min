...
export const UI = {
  is: {
    ...
    faqItems: [
      ...
      { q: "Get ég prentað barnasöguna mína sem alvöru bók?", a: "Þú getur pantað prentað eintak í gegnum lulu.com. Þar er hægt að velja harðspjaldabók eða bók með mjúkri kápu sem er send heim til þín." },
  ...
  en: {
    ...
    faqItems: [
      ...
      { q: "Can I print my child's story as a real book?", a: "Yes! We recommend lulu.com for printing your child's story. Lulu.com is completely unrelated to My Child's Story, we have no financial interest in recommending them, we simply find them to be a good service. Click 'Order a printed book' on the story screen for detailed instructions." },
