...
export const UI = {
  is: {
    ...
    faqItems: [
      ...
      { q: "Get ég prentað barnasöguna mína sem alvöru bók?", a: "Já! Við mælum með lulu.com til að prenta barnasöguna þína. Það fyrirtæki er algjörlega ótengt Barnasögu minni og við höfum enga fjárhagslega hagsmuni af því að mæla með þeim. Okkur finnst þetta einfaldlega þægileg og góð leið. Smelltu á 'Panta prentaða bók' á söguglugga til að sjá nánari leiðbeiningar." },
