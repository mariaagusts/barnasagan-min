...
export const UI = {
  is: {
    ...
    faqItems: [
      ...
      { q: "Kostar þjónustan eitthvað?", a: "Fyrstu tveir kaflarnir eru ókeypis. Fullur aðgangur er keyptur með eingreiðslu. Þetta er eitt verð og engin áskrift." },
      ...
      { heading: "Bókin þín" },
      { q: "Hvernig fer úrvinnslan fram?", a: "Veldu 'Skoða bókina þína'. Hver forskoðun er ný og sjálfstæð útgáfa." },
      ...
      { q: "Hvernig fæ ég fullbúna bók?", a: "PDF (forsíða + kaflaskipting) eða textaskrá. lulu.com fyrir prentaða útgáfu." },
      ...
      { q: "Get ég breytt textanum eftir að hann er búinn til?", a: "Já. 'Breyta texta' takki á söguglugga." },
      { q: "Getur textinn innihaldið villur?", a: "Já. Mælum með að fara yfir með 'Breyta texta' áður en þú hleður niður .pdf skrá." },
