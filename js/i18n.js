...
export const UI = {
  is: {
    ...
    feat3t: "✍️ Segðu bara frá", feat3d: "Þú þarft ekki að leita að réttum kafla. Skrifaðu í kassann efst það sem gerðist í dag, við finnum kaflann sem sagan á heima í og búum til spurninguna sem hún svarar.",
    ...
    editBtn: "✏️ Breyta", deleteBtn: "🗑 Eyða", saveBtn: "💾 Vista", cancelBtn: "Hætta við",
    ...
    faqItems: [
      ...
      { q: "Kostar þjónustan eitthvað?", a: "Fyrstu tveir kaflarnir eru ókeypis. Fullur aðgangur er keyptur með eingreiðslu, engin áskrift. Við bjóðum upp á tvo pakka: Fullan aðgang (eitt barn) og Fjölskyldupakkann (mörg börn). Sjá <a href='/pricing.html' style='color:var(--gold);'>verðskrá</a>." },
      { q: "Get ég skráð fleiri en eitt barn á sama aðgang?", a: "Já! Með Fjölskyldupakkanum getur þú bætt við eins mörgum börnum og þú vilt á sama aðgang. Hvert barn fær sína eigin sögu. Þú skiptir á milli barna með hnappinum efst á síðunni. Ef þú ert þegar með Fullan aðgang getur þú uppfært, sjá <a href='/pricing.html' style='color:var(--gold);'>verðskrá</a>." },
      ...
      { q: "Get ég bara skrifað það sem gerðist, án þess að leita að kafla?", a: "Já, og margir foreldrar vinna helst þannig. Efst á kaflayfirlitinu er kassinn „Hvaða sögu langar þig að segja frá í dag?“ þar sem þú skrifar frjálst, til dæmis um fyrsta leikskóladaginn. Við lesum textann, finnum kaflann sem hann á heima í og búum til spurninguna sem hann svarar. Þú sérð tillöguna, mátt færa hana í annan kafla eða laga spurninguna, og staðfestir svo. Ef barnið sagði eitthvað eftirminnilegt í leiðinni bjóðum við þér að setja það beint í Gullmolabankann." },
      ...
      { q: "Get ég talað í stað þess að skrifa?", a: "Já! Ýttu á 🎙 Segja frá hnappinn og talaðu, við breytum orðunum þínum í texta jafnóðum. Upptökunni sjálfri er hent eftir umritun, aðeins textinn er geymdur. Öll málvinnsla fer fram í lokin, þegar bókin er sett saman, svo talmálið þitt verður að fallegum bókartexta." },
      { q: "Getur síðan lesið spurningarnar upphátt?", a: "Já. Við hverja spurningu er 🔊 hnappur sem les hana upp með íslenskri rödd. Það er þægilegt þegar hendurnar eru uppteknar, t.d. með barn í fanginu." },
      ...
      { q: "Get ég bætt við fleiri spurningum eftir að kafla er lokið?", a: "Já! Spyrillinn metur sjálfur hvenær kafli er fullsagður, en þú getur alltaf opnað kaflann aftur og bætt við fleiri spurningum og svörum. Sumar minningar taka meira pláss í hjartanu en aðrar." },
      ...
      { q: "Hvar birtast myndirnar mínar?", a: "Myndir sem þú hleður upp í hverjum kafla birtast í fullri stærð með myndatexta í lok viðkomandi kafla, bæði í bókarsýninni og í PDF-skjalinu. Aðrar myndir sem þú bætir við safnið þitt birtast í myndasafni aftast í bókinni." },
  ...
  en: {
    ...
    feat3t: "✍️ Just tell us", feat3d: "You do not have to find the right chapter. Write what happened today in the box at the top, and we find the chapter the story belongs in and write the question it answers.",
    ...
    editBtn: "✏️ Edit", deleteBtn: "🗑 Delete", saveBtn: "💾 Save", cancelBtn: "Cancel",
    ...
    faqItems: [
      ...
      { q: "Is there a fee for the service?", a: "The first two chapters are free. Full access is a one-time payment, no subscription. We offer two plans: Full access (one child) and the Family plan (multiple children). See <a href='/pricing.html' style='color:var(--gold);'>pricing</a>." },
      { q: "Can I use one account for more than one child?", a: "Yes! With the Family plan you can add as many children as you like to one account. Each child gets their own story. You switch between children using the button at the top of the page. If you already have Full access you can upgrade, see <a href='/pricing.html' style='color:var(--gold);'>pricing</a>." },
      ...
      { q: "How do I pay?", a: "We use Kling.is as our payment processor. They accept Visa and Mastercard credit and debit cards. Payment is in Icelandic króna (ISK)." },
      { q: "Can I get a refund?", a: "Yes, we offer a 14-day refund policy. Contact us at <a href='mailto:hallo@saganmin.is' style='color:var(--gold);'>hallo@saganmin.is</a>." },
      { q: "When do I get access?", a: "Immediately after payment. You can start writing your child's story right away, no waiting." },
      ...
      { q: "How does the service adapt to our family?", a: "When you first sign in, the service asks whether your child has a mum and dad, two mothers, two fathers, or a single parent. This is saved and used by the system to ensure the right parent terms are used throughout the book. If you want to change this setting later, tap the 👨‍👩‍👧 button in the top right of the My Story screen." },
      ...
      { q: "Can I just write what happened, without finding a chapter?", a: "Yes, and many parents prefer working that way. At the top of the chapter overview there is a box, \"What story would you like to tell today?\", where you write freely, for example about the first day of preschool. We read the text, find the chapter it belongs in and write the question it answers. You see the suggestion, can move it to another chapter or edit the question, and then confirm. If your child said something memorable along the way, we offer to put it straight into the golden phrase bank." },
      ...
      { q: "Can I speak instead of typing?", a: "Yes! Press the 🎙 Speak button and talk, and we turn your words into text as you go. The recording itself is discarded after transcription, only the text is kept. All language polishing happens at the end, when the book is composed." },
      { q: "Can the site read the questions aloud?", a: "Yes. Next to each question there is a 🔊 button that reads it aloud. Handy when your hands are full, for example with a baby in your arms." },
      ...
      { q: "Can I add more questions after a chapter is complete?", a: "Yes! The interviewer senses when a chapter has been fully told, but you can always reopen a chapter and add more questions and answers. Some memories simply take up more room in the heart than others." },

      { heading: "Your book" },
      { q: "How is the story generated?", a: "Once you have provided several answers, you can select 'Preview your book'. The system organizes your responses into a logical, flowing narrative which you can then review and edit." },
      { q: "Is the book always the same when I preview it?", a: "No. Each time you click 'Preview your book' a new and independent version of the story is created. This means you can try different styles and get a fresh version every time.\n\nWhen you preview a version you like, you can always return to it using the panel on the right side of the screen. Previous versions are stored there so you can compare them or download the one you prefer." },
      ...
      { q: "Can I print my child's story as a real book?", a: "Yes. Download the print PDF and take it to a print service. In Iceland we recommend Háskólaprent (haskolaprent.is) for a fast, affordable paperback and Samskipti (samskipti.is) for a hardcover. Abroad, lulu.com is a good option. Click the 🖨️ button in the book view for details." },
      { q: "What if I want the story to be simple and direct, without emotional flourishes?", a: "You can choose 'Focused' when creating your book. The system then writes a clean, direct children's story where the key facts take centre stage, without sentimental language or added flourishes." },
