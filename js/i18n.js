...
export const UI = {
  is: {
    ...
    faqItems: [
      ...
      { q: "Af hverju er verðið í evrum?", a: "Greiðslumiðlarinn okkar, Paddle, styður ekki íslenskar krónur að svo stöddu. Því er gjaldfært í evrum sem jafngilda uppgefnu verði okkar í krónum." },
      ...
      { q: "Get ég prentað barnasöguna mína sem alvöru bók?", a: "Sæktu PDF skjalið og pantaðu prentað eintak í gegnum lulu.com. Boðið er upp á harðspjaldabækur eða bækur með mjúkri kápu sem eru sendar heim til þín." },
