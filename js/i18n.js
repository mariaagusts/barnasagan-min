...
export const UI = {
  is: {
    ...
    faqItems: [
      ...
      { q: "Get ég bætt við fleiri spurningum eftir að kafla er lokið?", a: "Já! Þegar kafla er lokið birtist takki sem gerir þér kleift að bæta við fleiri spurningum og svörum í sama kafla." },
    ...
    3. Skrunaðu niður og ýttu á „View more" (Sjá meira).<br>
    4. Veldu „Add to Home Screen" (Bæta við heimaskjá).<br><br>
  ...
  en: {
    ...
    heroTitle: "Write your child's story",
    heroSub: "We ask you warm questions about your child's life, helping you capture the moments that matter.",
    heroCta1: "Start writing →", heroCta2: "Sign in",
    heroStats: ["Chapters","Questions","Story"],
    featTitle: "How does it work?",
    featSub: "More than a questionnaire, a chance to reflect, remember and share.",
    feat1t: "We ask you", feat1d: "Warm questions about your child's life, chapter by chapter.",
    feat2t: "Speak or type", feat2d: "Answer at your own pace, with your voice or keyboard.",
    feat3t: "Your child's story", feat3d: "We weave your answers into a beautiful story you can give to your child.",
    feat4t: "Always saved", feat4d: "Continue anytime, anywhere, your progress follows you.",
    ctaTitle: "Start today", ctaSub: "Turn your child's story into a keepsake they will always treasure.",
    ...
    faqItems: [
      ...
      { q: "Can I add more questions after a chapter is complete?", a: "Yes! When a chapter is complete, a button appears allowing you to add more questions and answers to the same chapter." },
