...
export const UI = {
  ...
  en: {
    ...
    faqItems: [
      ...
      { q: "Why is the price in euros and not Icelandic króna?", a: "My Child's Story is an Icelandic project, but our payment processor (Paddle) unfortunately does not support Icelandic króna. We therefore charge in euros (€45 / €80). Your bank will automatically convert to króna at the exchange rate on the day of payment." },
