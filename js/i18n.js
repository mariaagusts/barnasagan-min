...
export const UI = {
  is: {
    ...
    faqItems: [
      ...
      { heading: "Bókin þín" },
      { q: "Hvernig fer úrvinnslan fram?", a: "Þegar þú hefur svarað nokkrum spurningum getur þú valið 'Skoða bókina þína'. Kerfið greinir svörin þín og setur þau upp í rökrétta og flæðandi barnasögu sem þú getur síðan yfirfarið og breytt. Athugaðu að í hvert sinn sem þú forskoðar bókina mun bókin búa til sjálfstæða sögu. En þú getur ávallt kallað fram gamla útfærslu í flipanum hægra megin." },
      { q: "Hvernig fæ ég fullbúna bók?", a: "Þú getur hlaðið barnasögunni niður sem PDF skjali sem er faglega umbrotið með forsíðu og kaflaskiptingu. Einnig er hægt að flytja textann yfir í textaskrá. Án þess að það sé á nokkurn hátt tengt okkur, þá getum við mælt með lulu.com til að fá útprentaða bók byggða á bókinni sem þú hleður niður sem .pdf skjal." },
